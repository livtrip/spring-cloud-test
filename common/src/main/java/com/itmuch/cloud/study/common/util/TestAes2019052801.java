...
//            System.out.println("加密后的文本:" + encryptedContent);
            ...
            String encryptedContent1 = "40dd88e115aab34ffa949dfb245e8e97";
            String secretKey1 = "46356afe55fa3cea9cbe73ad442cad47";
            byte[] encryptedContentToBinaryStr = parseHexToBinaryStr(encryptedContent1);
            byte[] decryptedContentBytes = decrypt(encryptedContentToBinaryStr, secretKey1);
